Process of transporting macromolecules via ==**vesicles**== in cells
* ==**Cytosis**==: Transport mechanism of large quantities of molecules.
# Endocytosis
Process in which a particle is transported inside the cell, using vacuoles.
## Phagocytosis
We can view phagocytosis as meaning ==**Cell Eating**==.
* ==**Phago**==: Greek word for eating.
...
1. A non-specific extracellular fluid is captured into the cell via endocytosis.
2. It fuses with the endosome for metabolism.

# Exocytosis
Process in which a particle is transported outside the cell, using vacuoles.
