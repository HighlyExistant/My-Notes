...
Through the same reasoning a function is bijective if there is a one-to-one correspondence between the codomain and the domain. For this reason a function is bijective if it is **invertible** and it is **surjective**.
