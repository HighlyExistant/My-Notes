...
## Examples
If we wanted to write the vector $\begin{bmatrix}3 & 4\end{bmatrix}$ we would write them as $$3x + 4y$$ where $x, y$ form our standard basis vectors.
...
for all $V$. It also satisfies that the identity maps unto the field identity: $$L(0_{V})=0$$ as well as being a [[Mathematics/Pure Maths/Under Revision/Category Theory#Homomorphisms|homeomorphism]]: $$L(\lambda\vec{u}+\vec{v})=\lambda L(\vec{u})+L(\vec{v})$$
# Bilinear Form
