...
* The Fed has 3 ==administered rates== that serve as an outside influence on many equilibrium interest rates and are directly controlled by the Fed:
	...
	3. Discount Rate
		...
		* ==***Only this one is paid to the Fed***==
		* It is supposed to provide a low interest rate liquidity if banks are unable to obtain funds.
* Of the 3 only 2 are used to influence market equilibrium interest rates in the money market, the ==**ON RRP**== and ==**IORB**==

## Federal Funds Rate
Is the interest rate banks charge on overnight loans to each other.
## Money Market
financial market in which ==**short-term, low-risk debt securities are traded**==, including:
* U.S. Treasury bills 
